...
const About = () => {
    return (
      <div className="bg-[#272626] py-10">
        <div className="grid md:grid-cols-2 gap-4 my-container py-9 px-4 md:px-0  text-white">
          <div data-aos="md:fade-right" className="md:mt-16">
